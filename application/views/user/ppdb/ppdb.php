      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 entries">
            <div class="row">
            <?php if ($hasil_ppdb1 == "NULL")
        
            echo "<h2 style='padding-left:2rem;'>Data tidak tersedia</h2>";
            
            else{
              foreach($hasil_ppdb1 as $row) 
                {
              ?>
                <div class="col-lg-6">
                  <article class="entry" data-aos="fade-up">
                    <div class="entry-img">
                      <img src="<?php echo base_url() ?><?php echo $row->gambar_ppdb ?>" alt="" class="img-fluid">
                    </div>

                    <h2 class="entry-title">
                      <a href="blog-single.html"><?php echo $row->judul_ppdb ?></a>
                    </h2>

                    <div class="entry-meta">
                      <ul>
                      <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="#"><?php echo $row->penulis_ppdb ?></a></li>
                      <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="#"><time datetime="01-01-2020"><?php   $tgl = $row->tgl_ppdb; echo date("d-F-Y", strtotime($tgl));  ?></time></a></li>
                      </ul>
                    </div>

                    <div class="entry-content">
                      <p style="font-size:14px">
                        <?php echo substr ($row->isi_ppdb,0,150)?> ............................
                      </p>
                      <div class="read-more">
                        <a href="<?php echo base_url() ?>user/detail_ppdb/<?php echo $row->id_ppdb ?>">Selengkapnya</a>
                      </div>
                    </div>
                  </article>
                </div>
