      ...
      <div class="container">
        ...
        <div class="row justify-content-center" data-aos="fade-up">
          ...
          <?=$this->session->set_flashdata('sukses')?>
            <form action= "<?php echo base_url()?>User/simpan_inbox" method="post" role="form" enctype="multipart/form-data" class="php-email-form">
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" id="text-input" name="name" class="form-control" id="name" placeholder="Tuliskan nama lengkap Anda" data-rule="minlen:4" data-msg="Mohon untuk menuliskan minimal 4 karakter" />
                  <div class="validate"></div>
                </div>
                <div class="col-md-6 form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Tuliskan alamat email Anda" data-rule="email" data-msg="Dimohon masukkan alamat email yang benar" />
                  <div class="validate"></div>
                </div>
              </div> 
              <div class="form-group">
                <textarea class="form-control" name="pesan" rows="5" data-rule="required" data-msg="Mohon tuliskan pesan Anda" placeholder="Tuliskan pesan Anda"></textarea>
                <div class="validate"></div>
              </div> -->
                              <!-- </div>
