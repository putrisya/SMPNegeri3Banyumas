...
<section id="blog" class="blog" style="background-color:#eeeeee">
    <div class="container" style="max-width: 1300px;">
      	<div class="row no-gutters">
			<div class="col-lg-8" style="background-color:white;border-radius:0.30rem" data-aos="fade-left">
				<div class="title text-center" style="padding-top:2rem;">
					<h1 class="mb-10">Data Staff Tata Usaha</h1>
				...
				<table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center">
					...
					<tbody>
          <?php if ($data_staff == "NULL")
          
          echo "<h2>Data tidak tersedia</>";
          
          else{
					$no = 0; foreach($data_staff as $row) 
					{ 
						$no++;
					?>
						<tr>
