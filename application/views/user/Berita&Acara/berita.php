          ...
          <div class="col-lg-6">
            <div class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a href="blog-single.html"><?php echo $row->judul_berita ?></a>
              </h2>

              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="#"><?php echo $row->penulis_berita ?></a></li>
                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="#"><time datetime="01-01-2020"><?php $tgl = $row->tgl_berita; echo date("d-F-Y", strtotime($tgl)) ?></time></a></li>
                </ul>
              </div>
