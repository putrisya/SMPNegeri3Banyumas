        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single" data-aos="fade-up">
              ...
              <div class="entry-img">
                <img src="<?php echo base_url() ?><?php echo $gambar_berita ?>" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="#" style="font-size:25px"><?php echo $judul_berita ?></a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="#"><?php echo $penulis_berita ?></a></li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time datetime="2020-01-01"><?php  $tgl = $tgl_berita; echo date("d-F-Y", strtotime($tgl)) ?></time></a></li>
