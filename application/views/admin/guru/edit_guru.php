                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_guru" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <?php foreach($mapel as $row1) 
                                        {
                                        ?>
                                    <select name="mapel" class="form-control" > 
                                        <?php $no = 0; foreach($id_mapel as $row) 
                                        {
                                        ?>
                                        <option value="<?php echo $row['id_mapel']; ?>" <?php if ($row['id_mapel']==$row1['id_mapel']) echo "selected='selected'";?>><?php echo $row['nama']?></option>
                                         <?php 
                                         } ?>
                                           <?php 
                                         } ?>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                <img src="<?php echo base_url()?><?php echo $foto ?>" width="300" text-align="center">
