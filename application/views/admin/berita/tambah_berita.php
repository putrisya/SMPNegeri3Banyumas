                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/simpan_berita" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label" required>Penulis</label>
                                </div>
                                <div class="col-12 col-md-9">
