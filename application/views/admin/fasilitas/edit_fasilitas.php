                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_fasilitas" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" value="<?php echo $judul_fasilitas ?>" id="text-input" name="judul" placeholder="judul" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea class="form-control" name="isi" rows="15"><?php echo $isi_fasilitas ?></textarea>
                                </div>
                              </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                <img src="<?php echo base_url()?><?php echo $gambar_fasilitas ?>" width="300" text-align="center">
