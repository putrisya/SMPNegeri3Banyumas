                        ...
                        <form action="<?php echo base_url()?>admin/simpan_galeri" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="file" id="file-input" name="berkas" class="form-control-file" required>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="deskripsi" placeholder="deskripsi" class="form-control" required>
                                </div>
                              </div>
                          </div>
