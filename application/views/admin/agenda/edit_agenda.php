...
<body>
                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_agenda" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" value="<?php echo $judul_agenda ?>" id="text-input" name="judul_agenda" placeholder="judul artikel" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea class="form-control" name="isi_agenda" rows="15"><?php echo $isi_agenda ?></textarea>
                                </div>
                              </div>
                               ...
                               <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                <img src="<?php echo base_url()?><?php echo $gambar_agenda ?>" width="300" text-align="center">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="penulis_agenda" value="<?php echo $penulis_agenda ?>" placeholder="penulis artikel" class="form-control">
                                </div>
                              </div>
    ...
    <script>
        var editor=CKEDITOR.replace('isi_agenda');
