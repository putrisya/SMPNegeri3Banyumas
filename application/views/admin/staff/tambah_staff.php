                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Tambah</strong> Staf
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/simpan_staff" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="alamat" placeholder="alamat" class="form-control" required>
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="jabatan" placeholder="jabatan" class="form-control" required>
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="file" id="file-input" name="gambar_staff" class="form-control" required>
                                </div>
                              </div>
                          </div>
